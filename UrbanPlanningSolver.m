%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                          Urban Planning solver                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [v,phi1,phi2,phi3,u] = UrbanPlanningSolver(n,savename,maxIter,tol,maxIterProj,tolProj,a,epsilon,example)
disp(['+++++ Urban Planning with a = ',num2str(a),' and epsilon = ',num2str(epsilon),' +++++']);
%-------------------------------------------------------------------------
...
while ( error > tol && iter <= maxIter )
    ...
    [phi1,phi2] = MSprojectUPmex(phi1,phi2,a,epsilon,hz,maxIterProj,tolProj); 
    phi3(phi3<0) = 0;
    % Update v
